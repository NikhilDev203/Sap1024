...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mystorestorefront/electronics/en",
						"https://electronics.local:9002/mystorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mystorestorefront/electronics/en",
						"https://electronics.local:9002/mystorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mystorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mystorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mystorestorefront/electronics/en",
						"https://electronics.local:9002/mystorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mystorestorefront",
						"https://electronics.local:9002/mystorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mystorestorefront",
						"https://electronics.local:9002/mystorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mystorestorefront/electronics/en",
						"https://electronics.local:9002/mystorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
