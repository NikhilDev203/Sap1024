 ...
 */
package com.hybris.core.constants;

/**
 * Global class for all MystoreCore constants. You can add global constants for your extension into this class.
 */
public final class MystoreCoreConstants extends GeneratedMystoreCoreConstants
{
	public static final String EXTENSIONNAME = "mystorecore";


	private MystoreCoreConstants()
	{
		//empty
	}
