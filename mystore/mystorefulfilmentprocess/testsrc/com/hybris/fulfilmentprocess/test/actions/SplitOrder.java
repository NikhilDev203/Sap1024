 ...
 */
package com.hybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MystoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MystoreFulfilmentProcessConstants.PARENT_PROCESS);
