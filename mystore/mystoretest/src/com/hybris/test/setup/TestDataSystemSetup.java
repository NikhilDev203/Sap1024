...
import com.hybris.test.constants.MystoreTestConstants;
import com.hybris.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MystoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mystoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mystoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mystoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/mystoretest/import/csquotes.impex");
		}
	}
}
